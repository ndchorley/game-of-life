...
const initialGrids = {
    ...
    circleWithStem: {
        sideLength: gridSize,
        liveCells: [
            {x: 13, y: 13}, {x: 14, y: 13}, {x: 15, y: 13}, {x: 16, y: 14},
            {x: 12, y: 14}, {x: 12, y: 15}, {x: 12, y: 16}, {x: 16, y: 15},
            {x: 16, y: 16}, {x: 13, y: 17}, {x: 14, y: 17}, {x: 15, y: 17},
            {x: 14, y: 18}, {x: 14, y: 19}, {x: 14, y: 20}, {x: 14, y: 21}
        ]
    }
};
